...
def main():
    ...
    for filepath in files:
        ...
        # exclude the files giantswarm/github's alignment writes into this fork
        # (generated workflows, pre-commit, yamllint, nancy, DCO): Giant Swarm
        # fork infrastructure, regenerated by the align-files workflow, no header.
        if filepath.startswith(".github/workflows/zz_generated.") or filepath in [
            ".pre-commit-config.yaml", ".yamllint.yaml", ".nancy-ignore.generated", "DCO",
        ]:
            continue
