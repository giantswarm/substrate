...
external snapshot store is patched in after the install; all ten are written for upstream and leave at the first release that carries them. The Postgres Secret patch is upstream's own open pull
